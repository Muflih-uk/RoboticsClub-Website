...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="flex pt-[20px] px-[10px] md:px-[20px] items-center space-y-[50px] flex-col h-screen">
      <div
       ref={scrollRef}
        ...
        <div className="flex  items-center justify-center md:p-[30px] flex-nowrap space-x-[30px] min-w-max">
          {
            photos.map((item,index)=>(
              <Image key={index} src={item} width={100} height={100} alt={item} className="shadow-xl md:w-[200px] md:h-[200px] rounded-[30px] hover:scale-105 hover:rotate-8"/>
            ))
          }
        </div>
      </div>
      <div className="relative group flex items-center w-[300px] h-[400px] justify-center md:w-[650px] md:h-[600px]">
